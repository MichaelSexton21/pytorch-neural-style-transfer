...
if __name__ == "__main__":
    ...
    content_img_name = sys.argv[1].split('/')[-1]
    style_img_name = sys.argv[2].split('/')[-1]
    ...
    # Settings Dictionary
    optimization_config = {'content_img_name': content_img_name, 'style_img_name': style_img_name, 'height': height, 'content_weight': content_weight, 'style_weight': style_weight, 'tv_weight': tv_weight, 'optimizer': optimizer, 'model': model, 'init_method': init_method, 'saving_freq': saving_freq, 'content_images_dir': content_images_dir, 'style_images_dir': style_images_dir, 'output_img_dir': output_img_dir, 'img_format': img_format, 'iterations': iterations}
